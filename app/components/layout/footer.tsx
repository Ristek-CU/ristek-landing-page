...
export default function Footer() {
  return (
    <>
      ...
      <footer className="w-full bg-gray-200 py-6 sm:py-8 lg:py-10">
        <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
          <div
            className="flex flex-col items-center text-center
            md:flex-row md:justify-between md:items-start md:text-left gap-6 sm:gap-8 md:gap-12 pb-6 sm:pb-8">
            <div className="flex justify-center md:justify-start items-center">
              <Image src="/images/logo/Logo.svg" alt="RISTEK Logo" width={180} height={45}
                className="w-44 sm:w-48 md:w-[200px] lg:w-[240px] h-auto object-contain" />
            </div>
            <div
              className="flex flex-col items-center text-center
              ...
              <div className="flex items-center justify-center md:justify-end gap-2">
                ...
                <span className="text-sm sm:text-base text-[#00C6E8] font-semibold">
              ...
              <div
                className="text-sm sm:text-base flex flex-col items-center md:items-end">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4 sm:gap-6">
            <p className="text-gray-900 font-medium text-base sm:text-lg md:text-xl order-2 sm:order-1">
              © 2025 RISTEK
            </p>
            <div className="flex items-center justify-center space-x-5 sm:space-x-6 md:space-x-7 order-1 sm:order-2">
              ...
              transition-all duration-300 hover:scale-110" aria-label="Spotify">
                <FaSpotify className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
              </Link>
            </div>
          </div>
        </div>
